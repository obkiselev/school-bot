...
## Завершённые задачи (v0.1.4)

| # | Задача | Статус |
|---|--------|--------|
| 25 | Меню команд бота в Telegram (set_my_commands) | ✅ Готово |
...
### v0.1.4 — 2026-02-27
- Меню команд бота в Telegram — все команды (/start, /allow, /block, /users) доступны через кнопку "/"
