# School Bot — Единый школьный Telegram-бот (v0.3.8)
...
- 🔔 **Уведомления** — ежедневные оповещения: оценки в 18:00, ДЗ в 19:00 (`/settings`)
...
- ⏳ Фаза 4: Production (rate limiting, /help, /profile — готово; деплой на VPS — в планах)
