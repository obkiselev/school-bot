# School Bot — Единый школьный Telegram-бот (v0.3.2)
...
- ⏳ **Оценки** — с фильтрацией по датам и предметам (в разработке)
...
2. Вы отправляете `/start` → сразу меню тестирования
3. Выбираете язык → тему → количество вопросов → проходите тест
4. Смотрите историю и статистику
...
| `/raspisanie` | Расписание уроков (родители) |
...
- ✅ Фаза 1: Фундамент
- 🔄 Фаза 2: Основные команды (расписание + навигация готовы, оценки и ДЗ в работе)
- ⏳ Фаза 3: Уведомления
- ⏳ Фаза 4: Production
