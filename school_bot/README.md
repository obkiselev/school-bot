# School Bot — Единый школьный Telegram-бот (v0.4.3)
...
- ⏳ Фаза 4: Production (rate limiting, /help, /profile, устойчивые уведомления, 72 теста — готово; деплой на VPS — в планах)
